...
# disp_name should only be set for the Blinka/PyGame environment
disp_name = os.getenv("TESSERAE_DISPLAY")

# app configuration (common section: MCU and Blinka/PyGame)   ----------------
#                    also edit the specific section below!
...
# --- configuration on MCUs   ------------------------------------------------

if not disp_name:
  app_config.name     = board.board_id         # use this default or a
  #pp_config.name     = "Kitchen Dashboard"    # set pretty name manually
...
# --- configuration for Blinka/PyGame runtime (emulation, pi-appliance)  -----
...
if disp_name:
  ...
  app_config.always_on = True          # loop
